...
const PaymentGatewaySolution = () => {
    useEffect(() => {
        document.title = `Payment Gateway Solution - ${config.app_name}`
    }, [])
    return (
        <>
            ...
            <div className="absolute left-0 right-0" style={{top: 65}}>
                <div className={`bg-white flex row item-center h-650 pl-4 pr-4 ${styles.TopSection}`}>
                    <div className={`flex column grow-1 w-50 ${styles.TopSectionInfo}`}>
                        ...
                        <h2 className={`text size-46 mt-1 ${styles.TopSectionTitle}`}>Terima Pembayaran dari Bank dan Dompet Digital</h2>

                        <div className="flex ro">
                            <button className="primary">Coba Sekarang</button>
                        </div>
                    </div>
                    <img src="/images/illustration/payment-gateway.png" alt="Payment Gateway" className={styles.TopIllustration} />
                </div>
