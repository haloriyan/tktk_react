            ...
            <div className="absolute left-0 right-0" style={{top: 70}}>
                <div className="bg-white flex row item-center h-650 pl-4 pr-4">
                    <div className="flex column grow-1 w-50">
                        <h2 className="text size-46 mt-1 mb-0">
                            Buat Website Toko Online untuk Jualan, Gratis!
                        </h2>
                        <div className="text size-20 lh-35 mt-2 weight-300">
                ...
                <div className={`${styles.Section} flex row gap-20 mt-5 mb-0`}>
                    <div className="flex column w-40">
                        <h3 className="mt-0 text size-36">Satu Solusi UMKM <br /> dan Bisnis Digital</h3>
                        <div className="w-20 h-5 rounded-max bg-primary"></div>
                    </div>
                    <div className="flex column grow-1 w-60">
                        <div className="text size-20 lh-35 weight-300">
                ...
                <div className={`${styles.Section} bg-whites flex column item-center`}>
                    ...
                    <div className="flex row item-center gap-10 w-100">
                        <div className="flex column item-center basis-4 grow-1 bg-white p-2 rounded-more border bottom-6 primary transparent">
